...
export default function BentoSummarySlide({
  metrics,
  isRoastMode,
  roast,
}: SlideProps) {
  const items = [
    {
      ...
      color: "text-lunar-100",
      size: "col-span-1 row-span-1",
    },
    {
      label: "Files Created",
      value: metrics.totalFilesCreated,
      color: "text-purple-300",
      size: "col-span-1 row-span-1",
    },
    {
      label: "Edits",
      value: formatNumber(metrics.totalEdits),
      color: "text-orange-300",
      size: "col-span-1 row-span-1",
    },
    {
      label: "Most Productive Hour",
      value: formatHour(metrics.mostProductiveHour),
      color: "text-lunar-200",
      size: "col-span-1 row-span-1",
    },
  ];
  ...
  return (
    ...
    >
      <div className="text-center">
        ...
        <p className="text-lunar-400 font-medium mb-4">
          A snapshot of your coding grind
        </p>
      </div>
      <div className="grid grid-cols-2 md:grid-cols-4 auto-rows-fr gap-4 mb-8">
        {items.map((item, i) => (
          ...
          >
            ...
            <span
              className={`text-4xl md:text-5xl font-mono font-black ${item.color} tracking-tighter`}
            >
              {item.value}
            </span>
          </motion.div>
